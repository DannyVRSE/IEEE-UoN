                ...
                <div className="container">
                    <div className="inner-div-2">
                        ...
                        <div>
                            ...
                            <div>
                                <button disabled={isMember} onClick={societyName === "ieee_uon" ? () => navigate("/registration") : handleJoin} className="btn btn-info home-btn"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-person-fill-add" viewBox="0 0 16 16">
